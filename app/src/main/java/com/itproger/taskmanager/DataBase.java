...
public class DataBase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String querry = String.format("CREATE TABLE %s (ID INTEGER PRIMARY KEY AUTOINCREMENT, %s TEXT NOT NULL);", db_table, db_column);
        db.execSQL(querry);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        String querry = String.format("DELETE TABLE IF EXISTS %s", db_table);
        db.execSQL(querry);
    }
